...
export default function Settings() {
  ...
  return (
    <div>
      ...
      <div className="settings-tabs" style={{ display: 'flex', gap: '0.25rem', marginBottom: '1.5rem', background: 'var(--navy-900)', borderRadius: '10px', padding: '0.25rem', width: '100%', flexWrap: 'wrap' }}>
        {tabs.map(t => (

...
export default function Layout({ children }: { children: ReactNode }) {
  ...
  return (
    ...
    <div style={{ display: 'flex', minHeight: '100vh', background: 'var(--navy-950)' }}>
        ...
        <div style={{ padding: '1rem', borderBottom: '1px solid var(--border)', display: 'flex', alignItems: 'center', gap: '0.75rem', minHeight: '64px' }}>
          {settings?.company_logo ? (
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.25rem' }}>
              ...
              <div style={{ fontSize: '0.65rem', color: 'var(--blue-400)', fontWeight: '600', letterSpacing: '0.08em', textTransform: 'uppercase' }}>TalenFlow</div>
            </div>
          ) : (
            <>
              ...
              <div>
                ...
                <div style={{ fontSize: '0.65rem', color: 'var(--blue-400)', fontWeight: '600', letterSpacing: '0.08em', textTransform: 'uppercase' }}>TalentFlow</div>
              </div>
            </>
          )}
        </div>
      ...
      {/* Main content */}
      <div className='main-content-with-sidebar' style={{ marginLeft: '240px', flex: 1, display: 'flex', flexDirection: 'column' }}>
        {/* Top bar */}
        <header style={{
